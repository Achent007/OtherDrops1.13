...
public enum CreatureGroup {
    CREATURE_HOSTILE(BLAZE, CREEPER, ELDER_GUARDIAN, ENDER_DRAGON, ENDERMITE, EVOKER, GHAST, GUARDIAN, HUSK, ILLUSIONER, MAGMA_CUBE, PHANTOM, PIGLIN, PIGLIN_BRUTE, SHULKER, SILVERFISH, SKELETON,
    		SLIME, STRAY, VEX, VINDICATOR, WARDEN, WITCH, WITHER, WITHER_SKELETON, ZOGLIN, ZOMBIE, ZOMBIE_VILLAGER, ZOMBIFIED_PIGLIN), 
